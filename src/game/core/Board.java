...
public class Board {
    ...
    public static final int PIECES_TO_REMOVE = 2;
    ...
    public String toString() {
        ...
        // Append column indices (A, B, C, etc.)
        boardString.append("   ");
        for (int i = 0; i < this.size; i++) {
            boardString.append(i == 0 ? "": "   ").append((char) ('A' + i));
        }
        ...
        // Append rows
        for (int i = 0; i < this.size; i++) {
            boardString.append(i + 1).append("│"); // Start row indices from 1
